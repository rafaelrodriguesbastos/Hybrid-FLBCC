...
import org.cloudbus.cloudsim.util.LibFile;
...
public class Helper {
	...
	public static void printResults(
		...
		String strTempExecutionTimeVmSelectionMean ="";
		String strTempExecutionTimeVmSelectionStDev="";
		String strTempExecutionTimeHostSelectionMean="";
		String strTempExecutionTimeHostSelectionStDev="";
		String strTempExecutionTimeVmReallocationMean="";
		String strTempExecutionTimeVmReallocationStDev="";
		String strTempExecutionTimeTotalMean="";
		String strTempExecutionTimeTotalStDev="";
		...
		if (outputInCsv) {
			...
			if (datacenter.getVmAllocationPolicy() instanceof PowerVmAllocationPolicyMigrationAbstract) {
				...
				strTempExecutionTimeVmSelectionStDev = String.valueOf(executionTimeVmSelectionStDev) ;
				strTempExecutionTimeVmSelectionMean = String.valueOf(executionTimeVmSelectionMean);
				strTempExecutionTimeHostSelectionMean= String.valueOf(executionTimeHostSelectionMean) ;
				strTempExecutionTimeHostSelectionStDev = String.valueOf( executionTimeHostSelectionStDev);
				strTempExecutionTimeVmReallocationMean = String.valueOf(executionTimeVmReallocationMean);
				strTempExecutionTimeVmReallocationStDev = String.valueOf(executionTimeVmReallocationStDev) ;
				strTempExecutionTimeTotalMean= String.valueOf(executionTimeTotalMean) ;
				strTempExecutionTimeTotalStDev = String.valueOf(executionTimeTotalStDev);
	...
	if (outputAbstractInCsv) {	
        ...
        meanTimeBeforeVmMigration+","+
        stDevTimeBeforeVmMigration+","+
        strTempExecutionTimeVmSelectionMean+","+
        strTempExecutionTimeVmSelectionStDev+","+
        strTempExecutionTimeHostSelectionMean+","+
        strTempExecutionTimeHostSelectionStDev+","+
        strTempExecutionTimeVmReallocationMean+","+
        strTempExecutionTimeVmReallocationStDev+","+
        strTempExecutionTimeTotalMean+","+
        strTempExecutionTimeTotalStDev;
        
        File file = new File(strPath+strFileName); 
        
        if (file.exists()) {
        	libFile.adicionarLinhaTxt(strDados, strPath, strFileName);
        }else {
        	libFile.escreverTxt(strDados, strPath, strFileName, strFileHeader);
