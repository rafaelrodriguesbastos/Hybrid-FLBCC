...
public abstract class IntFLBCCRunnerAbstract {
	/** The enable output. */
	...
	protected void start(String experimentName, String outputFolder, VmAllocationPolicy vmAllocationPolicy) {
		...
		try {
			PowerDatacenter datacenter = (PowerDatacenter) IntFLBCCHelper.createDatacenter(
					"Datacenter",
	...
	protected VmAllocationPolicy getVmAllocationPolicy(
		...
		if (vmAllocationPolicyName.equals("thr")) {
			vmAllocationPolicy = new IntFLBCCPowerVmAllocationPolicyMigrationStaticThreshold(
					hostList,
					vmSelectionPolicy,
					parameter);
		}  else {
	...
	public void setEnableOutput(boolean enableOutput) {
		IntFLBCCRunnerAbstract.enableOutput = enableOutput;
	}
