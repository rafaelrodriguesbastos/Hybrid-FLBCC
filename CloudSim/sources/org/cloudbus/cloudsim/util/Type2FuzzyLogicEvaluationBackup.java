 ...
 */
public class Type2FuzzyLogicEvaluationBackup 
{
    ...
    public Type2FuzzyLogicEvaluationBackup()
    {
    ...
    public Type2FuzzyLogicEvaluationBackup(double inCP, double inCC, double inRam, boolean plotMF, int isOverOrUnder, 
    ...
    */
    ...
    public double getLevelOfUse(Host host, boolean plotMF, int isOverOrUnder, int isTypeObjective, List<? extends Host> hostList,
		...
		Type2FuzzyLogicEvaluationBackup it2 = new Type2FuzzyLogicEvaluationBackup(cpStandartScale,ccStandartScale,ramStandartScale, plotMF, isOverOrUnder, isTypeObjective,
