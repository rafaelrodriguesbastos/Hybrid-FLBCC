...
public class Type2FuzzyLogicEvaluation 
{
    ...
    public Type2FuzzyLogicEvaluation(double inCP, double inCC, double inRam, boolean plotMF, int isOverOrUnder, 
        ...
        IT2_Consequent lowUtilization = new IT2_Consequent("LowUtilization", this.lowUtilizationMF, U);
        IT2_Consequent averageUtilization = new IT2_Consequent("AverageUtilization", this.averageUtilizationMF, U);
        IT2_Consequent highUtilization = new IT2_Consequent("AverageUtilization", this.highUtilizationMF, U);
    ...
    public void getPriority(double inCP, double inCC, double inRAM)
    {
    	...
    	JOptionPane.showMessageDialog(null, "inCP: "+inCP+" inCC: "+inCC+ "inRAM: "+inRAM);
