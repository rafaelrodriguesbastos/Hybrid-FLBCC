...
public class OverloadFuzzy2 
{
    ...
    public OverloadFuzzy2(double inCP, double inCC, double inRam, boolean plotMF, int isOverOrUnder, int isTypeObjective) {
		super();
		this.inCP = inCP;
		this.inCC = inCC;
		this.inRam = inRam;
    ...
    */
    ...
    public double getLevelOfUse(Host host, boolean plotMF, int isOverOrUnder, int isTypeObjective, List<? extends Host> hostList) {
		...
		OverloadFuzzy2 it2 = new OverloadFuzzy2(cpStandartScale,ccStandartScale,ramStandartScale, plotMF, isOverOrUnder, isTypeObjective);		
