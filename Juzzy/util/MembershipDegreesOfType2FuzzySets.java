...
public class MembershipDegreesOfType2FuzzySets implements Serializable {
	...
	public MembershipDegreesOfType2FuzzySets(double inCP, double inCC, double inRam, double xPonctual, double xInf,
			double xSup, double limitedCPDegreeOfMembershipUpperBound, double limitedCPDegreeOfMembershipLowerBound,
			double reasonableCPDegreeOfMembershipUpperBound, double reasonableCPDegreeOfMembershipLowerBound,
			double highCPDegreeOfMembershipUpperBound, double highCPDegreeOfMembershipLowerBound,
			double smallCCDegreeOfMembershipUpperBound, double smallCCDegreeOfMembershipLowerBound,
			double averageCCDegreeOfMembershipUpperBound, double averageCCDegreeOfMembershipLowerBound,
			double bigCCDegreeOfMembershipUpperBound, double bigCCDegreeOfMembershipLowerBound,
			double smallRAMDegreeOfMembershipUpperBound, double smallRAMDegreeOfMembershipLowerBound,
			double averageRAMDegreeOfMembershipUpperBound, double averageRAMDegreeOfMembershipLowerBound,
			double highRAMDegreeOfMembershipUpperBound, double highRAMDegreeOfMembershipLowerBound,
			double lowUtilizationDegreeOfMembershipUpperBound, double lowUtilizationDegreeOfMembershipLowerBound,
	...
	public int hashCode() {
		...
		result = prime * result + (int) (temp ^ (temp >>> 32));
		temp = Double.doubleToLongBits(inCC);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		temp = Double.doubleToLongBits(inCP);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		temp = Double.doubleToLongBits(inRam);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		...
		result = prime * result + (int) (temp ^ (temp >>> 32));
		temp = Double.doubleToLongBits(xInf);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		temp = Double.doubleToLongBits(xPonctual);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		temp = Double.doubleToLongBits(xSup);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (Double.doubleToLongBits(highUtilizationDegreeOfMembershipUpperBound) != Double
			...
			return false;
		if (Double.doubleToLongBits(inCC) != Double.doubleToLongBits(other.inCC))
			return false;
		if (Double.doubleToLongBits(inCP) != Double.doubleToLongBits(other.inCP))
			return false;
		if (Double.doubleToLongBits(inRam) != Double.doubleToLongBits(other.inRam))
			return false;
		...
		if (Double.doubleToLongBits(smallRAMDegreeOfMembershipUpperBound) != Double
			...
			return false;
		if (Double.doubleToLongBits(xInf) != Double.doubleToLongBits(other.xInf))
			return false;
		if (Double.doubleToLongBits(xPonctual) != Double.doubleToLongBits(other.xPonctual))
			return false;
		if (Double.doubleToLongBits(xSup) != Double.doubleToLongBits(other.xSup))
			return false;
		return true;
	}
