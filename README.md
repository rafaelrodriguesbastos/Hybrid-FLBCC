...
3. Rafael R Bastos, Bruno Moura Paz de Moura, Giancarlo Lucca, Helida Salles Santos, Adenauer Correa Yamin, Renata Reiser. ["Hybrid-FLBCC: Virtual Machine Consolidation in Cloud Infrastructures Exploring Flexible Computing"](https://ieeexplore.ieee.org/document/11197675). In IEEE International Conference on Fuzzy Systems (FUZZ), 2025.
